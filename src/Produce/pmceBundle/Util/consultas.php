...
class consultas {
    ...
    public static function InsEmbarcacionAportante($cn,$request){
    $pe=$request->request->get("");
    
    $CON=$cn->getDoctrine()->getConnection("PMCE");
    $sql = " insert into EMB_APORTANTES (id_embarcacion,id_solicitud) values('12314',(SELECT MAX(id_solicitud)+1 FROM SOLICITUD)); ";                    
    ...
    public static function InsertarSolicitud($cn,$request){
       ...
       // return $suma_PMCE+" HOLA GEOGRE ";//"inserto con exito en las 3 tablas!!";
